...
(function(){
  ...
  function md(t){
    ...
    t=t.replace(/\[BTN:([^\]]+)\]\(([^)]+)\)/gi,function(_,label,url){
      return '<a href="'+url+'" target="_blank" rel="noopener noreferrer" style="display:inline-block; margin:6px 0; padding:10px 16px; background:linear-gradient(135deg,'+b+',#e8c44a); color:#000; font-size:13px; font-weight:600; text-decoration:none; border-radius:12px; box-shadow:0 2px 10px rgba(212,175,55,0.25); text-align:center;">'+label+'</a>';
    });
    /* Regular links */
