...
(function(){
  ...
  css.textContent=[
    ".ec-wrap{position:fixed;bottom:0;right:24px;z-index:999999;font-family:'Inter',system-ui,sans-serif;font-size:14px;line-height:1.5;-webkit-font-smoothing:antialiased}",
    ".ec-fab{position:fixed;bottom:24px;right:24px;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,"+b+",#c9962b);box-shadow:0 4px 20px rgba(0,0,0,0.3);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:transform .2s;border:none;z-index:999999}",
    ".ec-fab:hover{transform:scale(1.06)}",
    ".ec-fab svg{width:24px;height:24px;fill:#000}",
    ".ec-win{position:fixed;bottom:0;right:24px;width:380px;height:620px;max-height:100vh;background:rgba(14,14,14,0.96);backdrop-filter:blur(40px);-webkit-backdrop-filter:blur(40px);border:1px solid rgba(255,255,255,0.06);border-bottom:none;border-radius:20px 20px 0 0;display:none;flex-direction:column;box-shadow:0 -4px 40px rgba(0,0,0,0.5);overflow:hidden}",
...
(function(){
  ...
  function send(){
    ...
    .then(function(raw){
      ...
      var reply=raw;try{var d=JSON.parse(raw);reply=d.output||d.response||d.text||d.message||raw;}catch(e){}
      addMsg("ai",reply);
    })
    .catch(function(err){
